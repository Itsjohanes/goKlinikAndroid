...
public class KonsultasiSelesai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_konsultasi_selesai);
        ...
        getSupportActionBar().setTitle("Konsultasi  Selesai");
        data(id_pasien);
    }
    @Override
    ...
    public void onBackPressed(){
        Intent back = new Intent(KonsultasiSelesai.this, KonsultasiActivity.class);
        startActivity(back);
    }
    public void data(String id_pasien) {
        Call<GetKonsultasi2> CoffeeCall = mApiInterface.getKonsultasi("getKonsultasiSudah",id_pasien);
        CoffeeCall.enqueue(new Callback<GetKonsultasi2>() {
            ...
            public void onResponse(Call<GetKonsultasi2> call, Response<GetKonsultasi2>
                ...
                try{
                    ...
                    ListKonsultasiSelesaiAdapter listDokterAdapter = new ListKonsultasiSelesaiAdapter(konsultasi2List);
                    mRecyclerView.setAdapter(listDokterAdapter);

                    //Onclick
                    listDokterAdapter.setOnItemClickCallback(new ListKonsultasiSelesaiAdapter.OnItemClickCallback() {
                        @Override

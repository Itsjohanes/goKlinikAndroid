...
public class PesananBelum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pesanan_belum);
        ...
        getSupportActionBar().setTitle("Dalam Perjanalan");
        data(id_pasien);
    }
    @Override
    ...
    public void onBackPressed(){
        Intent back = new Intent(PesananBelum.this, PesananActivity.class);
        startActivity(back);
    }
        public void data(String id_pasien) {
            Call<GetPesanan> CoffeeCall = mApiInterface.getPesanan("select_pesanan_belum_selesai",id_pasien);
            CoffeeCall.enqueue(new Callback<GetPesanan>() {
                ...
                public void onResponse(Call<GetPesanan> call, Response<GetPesanan>
                    ...
                    try{
                        ...
                        ListPesananBelumAdapter listDokterAdapter = new ListPesananBelumAdapter(dokterList);
                        mRecyclerView.setAdapter(listDokterAdapter);

                        //Onclick
                        listDokterAdapter.setOnItemClickCallback(new ListPesananBelumAdapter.OnItemClickCallback() {
                            @Override
